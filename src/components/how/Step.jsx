const Step = ({ icon, iconL, number, heading, body, gridString }) => {
  const className = `${gridString} shadow-md relative text-left px-10 pb-8 pt-8 bg-bg rounded-xl flex flex-col gap-2 justify-start max-w-[488px] md:gap-2 md:py-8 lg:max-h-[200px]`;
  return (
